...
$script.attr('src',(''+$script.data('src')).replace('&#038;','&')).removeAttr('data-src')}});$.fn.wGmaps=function(options){options=options||{};return this.each(function(){var self=this;$us.getScript($us.templateDirectoryUri+'/common/js/vendor/gmaps.js',function(){self._wGmaps=new $us.wGmaps(self,$ush.clone(options))})})};$(function(){$('.w-map.provider_google').wGmaps()})}(jQuery)